...
namespace EventSystem.Infrastructure.Migrations
{
    ...
    [Migration("20210327233319_InitMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventSystem.ApplicationCore.Entities.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EventSystem.Infrastructure.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EventSystem.ApplicationCore.Entities.EventParticipant", b =>
                {
                    b.HasOne("EventSystem.ApplicationCore.Entities.Event", "Event")
                        .WithMany("Participants")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EventSystem.ApplicationCore.Entities.User", "User")
                        .WithMany("ConnectedEvents")
